...
lib:btn("Nerdify 🤓", "http://www.roblox.com/asset/?id=9284968035", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/specowos/lua-projects/main/be-nerded/nerd.lua",true))()
end)

lib:btn("customload", "http://www.roblox.com/asset/?id=9284968460", function()
    ...
    CMSG("https://github.com/specowos/lua-projects/tree/main/customload")
end)

lib:btn("simple fps dot", "http://www.roblox.com/asset/?id=9284967520", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/specowos/lua-projects/main/small%20projects/crosshair%20mod/dot.lua"))()
end)
